    ...
    return {
        ...
        execute: function() {
            TrackComponent = (function () {
                function TrackComponent(_spotify, _routeParams, _locationstrategy) {
                ...
                TrackComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this._spotify.getTrack(this.id).subscribe(function (res) { return _this.renderArtist(res); });
                };
                TrackComponent.prototype.renderArtist = function (result) {
                    this.track = result;
                };
